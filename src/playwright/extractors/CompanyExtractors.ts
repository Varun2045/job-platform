...
export const SUPPORTED_50_COMPANIES = [
  ...
  { id: 'snowflake', name: 'Snowflake', pattern: 'snowflake.com', careerPage: 'https://www.snowflake.com/careers', jobBoardUrl: 'https://jobs.ashbyhq.com/snowflake' },
  ...
  { id: 'openai', name: 'OpenAI', pattern: 'openai.com', careerPage: 'https://openai.com/careers', jobBoardUrl: 'https://jobs.ashbyhq.com/openai' },
  ...
  { id: 'notion', name: 'Notion', pattern: 'notion.so', careerPage: 'https://www.notion.so/careers', jobBoardUrl: 'https://jobs.ashbyhq.com/notion' },
  ...
  { id: 'block', name: 'Block', pattern: 'block.xyz', careerPage: 'https://block.xyz/careers', jobBoardUrl: 'https://jobs.smartrecruiters.com/Block1' },
  { id: 'doordash', name: 'DoorDash', pattern: 'doordash.com', careerPage: 'https://careers.doordash.com', jobBoardUrl: 'https://jobs.smartrecruiters.com/DoorDash' },
